...
function initContactForm() {
    ...
    // Only attach handler on homepage to avoid double-handling on contact page (which has its own JS)
    const isHomePage = document.querySelector('.welcome-hero') !== null;
    ...
    contactForm.addEventListener('submit', function(e) {
        ...
        // Submit to backend (use same handler as contact page for consistency)
        ...
        .then(res => {
            if (res.success) {
                ...
                showMessage(res.message || 'Sorry, there was an error sending your message.', 'error');
            }
        })
        .catch(() => {
