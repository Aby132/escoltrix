...
$products = [
    ...
    [
        ...
        'detailed_description' => 'The Ardo Exothermic Weld system provides a permanent, low-resistance connection that effectively welds copper conductors to each other or to steel surfaces. The process utilizes a high-temperature reaction of powdered copper oxide and aluminum to produce superheated copper, creating a molecular bond that equals or exceeds the mechanical and electrical properties of the conductor itself.',
                ...
                <div class="product-info-section" data-aos="fade-left">
                    ...
                    <div class="product-actions">
                        ...
                        <?php if (isset($product['brochure'])): ?>
                            <a href="<?php echo $product['brochure']; ?>" target="_blank" class="btn btn-primary btn-large" style="background: var(--secondary-color); border-color: var(--secondary-color);">
